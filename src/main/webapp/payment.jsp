...
<script type="text/javascript">
	...
	function CreateOrderID()
	{
		...
		xhttp.open("GET","http://localhost:8080/OnlineShoppingApp/OrderCreation?amount="+number+"&id="+cid,false);
		/* alert("2"); */
		xhttp.send();
...
<script type="text/javascript">
	function OpenCheckOut()
	{
		...
		var options={
				...
				"callback_url":"http://localhost:8080/OnlineShoppingApp/Customer-home.jsp",
				"prefill":{
					"name":"Meet Vaghela",
					"email":"mvaghela6789@gmail.com",
					"contact":"9664565197"
				},
				"notes":{
					"address":"Ahmedabad"
