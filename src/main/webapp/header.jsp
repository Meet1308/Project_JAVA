					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Seller<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                       <li><a href="Seller-register.jsp">Registration</a></li> 
										<li><a href="Seller-login.jsp">Login</a></li> 
                                    </ul>
                                </li> 
                                
                                <li class="dropdown"><a href="#">Customer<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                       <li><a href="Customer-register.jsp">Registration</a></li> 
